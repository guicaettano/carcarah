...
import { productImages } from "../../lib/storefront-demo/product-images";
        ...
        {result && (
          <>
            <div className={styles.resultHeader}>
              <div><p>Resultados para</p><h2>&ldquo;{result.query}&rdquo;</h2></div><strong>{resultLabel}</strong>
            </div>
            {result.total === 0 ? (
              ...
              <div className={styles.grid} data-product-count={result.results.length}>
